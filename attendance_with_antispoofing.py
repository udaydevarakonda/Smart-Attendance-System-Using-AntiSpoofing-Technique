...
def my_link():
    ...
    def login():
        ...
        ######################################### Function to recognize the face #######################################
                    ...
                    bg_image = PhotoImage(file = "Photos/background_latest.png", master = attendance)
                    ...
                    topic = Label(attendance, text = manage , bg = "dark blue" , fg = "yellow", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE)
                    topic.place (x = 0, y = 0,relwidth = 1)
                    # faceslider()
                    # faceslidercolor()

                    photo1 = PhotoImage(file = "Photos/management1.png", master = attendance)
                    B1 = Button(attendance, image = photo1, text = "Employee Management",font = ("Times New Roman" , 15,"bold"), fg = "green", height =230, width = 265, command = manage_employee, compound = BOTTOM )
                    B1.place(x = 20, y = 100)

                    photo2 = PhotoImage(file = "Photos/face_recognizer.png",  master = attendance)
                    B2 = Button(attendance, image = photo2 , text = "Face Recognizer", font = ("Times new roman", 15,"bold"), fg = "green", height = 230, width= 265, command = face_recognize, compound = BOTTOM )
                    B2.place(x = 20, y = 400)
                    photo3 = PhotoImage(file = "Photos/train.png",  master = attendance)
                    B3 =  Button(attendance , image = photo3 , text = "Train the Data" , font = ("Times new roman", 15,"bold"), fg = "green" , height = 230, width= 265, command = train , compound = BOTTOM )
                    B3.place(x = 360, y = 100)
                    photo4 = PhotoImage(file = "Photos/exit1.png",  master = attendance )
                    B4 = Button(attendance, text="Exit",image = photo4, fg = "green",font = ("Times new Roman", 15,"bold"), height = 230, width = 265 , command = exit, compound = BOTTOM)
                    B4.place(x =1040, y = 400)
                    photo5 = PhotoImage(file = "Photos/report.png" ,  master = attendance)
                    B5 = Button(attendance, text = "Attendance Report", fg = "green", font = ("Times new roman", 15,"bold"), image = photo5, height = 230, width = 265, command = report, compound = BOTTOM)
                    B5.place(x = 360, y = 400)
                    photo6 = PhotoImage(file = "Photos/photosample.png",  master = attendance)
                    B6 = Button(attendance, text = "Photo Samples" ,fg = "green", font =("Times new roman",15,"bold"), image = photo6, height = 230, width = 265, command = photo_samples, compound = BOTTOM )
                    B6.place(x = 700, y= 100) 
                    photo7 = PhotoImage(file = "Photos/passwordchange.png", master = attendance)
                    B7 = Button(attendance, text="Admin Account" ,fg = "green",font =("Times new roman",15,"bold"), image = photo7, height = 230, width = 265, command = change, compound = BOTTOM )
                    B7.place(x = 700, y = 400)
                    photo8 = PhotoImage(file = "Photos/embeddings.png", master = attendance)
                    B8 = Button(attendance, text = "Extract Embeddings", fg = "green", font = ("Times new Roman", 15,"bold"), image = photo8, height = 230, width = 265,command= face_embedding, compound = BOTTOM)
    ...
    return ' .......... Thank you for visiting the System .......... '
