...
def send_mail():
    ...
    server.starttls()
    server.login('udaydevarakonda0802@gmail.com','Devarakonda@2080')
    for email in absent_staff_emails:
        server.sendmail('udaydevarakonda0802@gmail.com',
                    email,
                    'You are absent')
    ...
    msg['From'] = 'udaydevarakonda0802@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('udaydevarakonda0802@gmail.com','Devarakonda@2080')
...
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=19, minute=41)
sched.start()
